...
public class GenerateService {
    ...
    private String generateRandomValue(String tableName, String columnName, String dataType, String firstName, String lastName, String username, String email) {
        if (isForeignKey(tableName, columnName)) {
            ...
            Integer foreignKey = getRandomForeignKey(referencedTable, referencedColumn);
            if (foreignKey == null) {
                generateRandomData(referencedTable, 1, 1);
                foreignKey = getRandomForeignKey(referencedTable, referencedColumn);
            }
    ...
    private String getRandomAddress() {
        return random.nextInt(9999) + " " + getRandomString(10) + " St";
    }
